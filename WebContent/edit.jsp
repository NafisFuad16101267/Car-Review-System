...
<body>
	<% 
		...
		String sql ="select car_name, car_desc from car where id='"+id+"'";
		...
		<center>
			...
			<input type="text" value="<%=resultSet.getString("car_name")%>" name="name" required><br><br>
			<textarea placeholder="Car Description" rows="10" cols="50" name="desc" required><%=resultSet.getString("car_desc")%></textarea><br><br>									
			<input type="file" name="myimg" required><br><br>
